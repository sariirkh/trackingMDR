...
<head>
	...
	<link href="<?php echo base_url();?>assets/fileinput/css/fileinput.css" media="all" rel="stylesheet"
		type="text/css" />
...
<body class="login-layout"
	style="background-image:url(<?= base_url('assets/images/aki.jpg'); ?>);background-size:cover;">
									...
									<div class="widget-main">
										<div class="center">
											<h1>
												...
												<span class="blue" id="id-text2">Bengkel</span>
											</h1>
										...
										<form method="post" action="<?php echo base_url();?>main/login">
											<fieldset>
												...
												<hr>
												Distributed By <a href="https://blogbugabagi.blogspot.com" target="_blank"
													rel="noopener noreferrer">BlogBugaBagi</a>
